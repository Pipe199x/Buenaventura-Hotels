...
THEMATIC_MAPPINGS: Dict[str, str] = {
    ...
    "atención servicio": "service_quality",
    "servicio atención": "service_quality",
    "calidad": "service_quality",
    "organización": "service_quality",
    "organizacion": "service_quality",
    "coordinación": "service_quality",
    "coordinacion": "service_quality",
    "publicidad engañosa": "service_quality",
    "publicidad enganosa": "service_quality",
    "publicidad": "service_quality",
    "logística": "service_quality",
    "logistica": "service_quality",
    
    # ========== STAFF ATTENTION ==========
    "personal": "staff_attention",
    "personal del hotel": "staff_attention",
    ...
    "trato atención del personal": "staff_attention",
    ...
    "consideración con huéspedes": "staff_attention",
    "consideracion con huespedes": "staff_attention",
    "consideración": "staff_attention",
    "anfitriones": "staff_attention",
    "anfitrion": "staff_attention",
    
    # ========== ROOMS ACCOMMODATION ==========
    "habitación": "rooms_accommodation",
    "habitaciones": "rooms_accommodation",
    "habitacion": "rooms_accommodation",
    "habitación confort": "rooms_accommodation",
    ...
    "vista entorno": "rooms_accommodation",
    "paisaje": "rooms_accommodation",
    "paisajes": "rooms_accommodation",
    "balcón": "rooms_accommodation",
    "balcon": "rooms_accommodation",
    "terraza": "rooms_accommodation",
    "cabañas": "rooms_accommodation",
    "cabana": "rooms_accommodation",
    "cabaña": "rooms_accommodation",
    ...
    "calidad de alimentos": "food_dining",
    "calidad alimentos": "food_dining",
    "manejo de vajilla": "food_dining",
    "vajilla": "food_dining",
    "platos": "food_dining",
    "plato": "food_dining",
    "mesa": "food_dining",
    "mesas": "food_dining",
    "restaurante mesa": "food_dining",
    "bar": "food_dining",
    "tienda": "food_dining",
    
    # ========== MAINTENANCE FACILITIES ==========
    "mantenimiento": "maintenance_facilities",
    "mant": "maintenance_facilities",
    ...
    "pintura": "maintenance_facilities",
    "pinturas": "maintenance_facilities",
    "pared": "maintenance_facilities",
    "paredes": "maintenance_facilities",
    "plomería": "maintenance_facilities",
    "plomeria": "maintenance_facilities",
    "baño plomería": "maintenance_facilities",
    "baño plomeria": "maintenance_facilities",
    "plagas": "maintenance_facilities",
    "baño plagas": "maintenance_facilities",
    
    # ========== INFRASTRUCTURE AMENITIES ==========
    "instalaciones": "infrastructure_amenities",
    "instalaciones generales": "infrastructure_amenities",
    ...
    "equipos": "infrastructure_amenities",
    "infraestructura": "infrastructure_amenities",
    "infraestructura general": "infrastructure_amenities",
    "infraestructura mantenimiento": "infrastructure_amenities",
    "piscina": "infrastructure_amenities",
    "piscinas": "infrastructure_amenities",
    "zonas húmedas": "infrastructure_amenities",
    "zonas humedas": "infrastructure_amenities",
    "gimnasio": "infrastructure_amenities",
    "gym": "infrastructure_amenities",
    "spa": "infrastructure_amenities",
    "bienestar": "infrastructure_amenities",
    ...
    "áreas comunes": "infrastructure_amenities",
    "areas comunes": "infrastructure_amenities",
    "zona comun": "infrastructure_amenities",
    "zonas comunes": "infrastructure_amenities",
    "ambiente": "infrastructure_amenities",
    "atmósfera": "infrastructure_amenities",
    "atmosfera": "infrastructure_amenities",
    "tranquilidad": "infrastructure_amenities",
    "actividades": "infrastructure_amenities",
    "planes": "infrastructure_amenities",
    "actividades planes": "infrastructure_amenities",
    
    # ========== CLEANLINESS GENERAL ==========
    "limpieza": "cleanliness_general",
    "limpieza general": "cleanliness_general",
    "aseo limpieza": "cleanliness_general",
    "aseo": "cleanliness_general",
    ...
    "olores": "cleanliness_general",
    "olor": "cleanliness_general",
    "olores olor": "cleanliness_general",
    ...
    "internet conectividad": "connectivity_technology",
    ...
    "teléfono": "connectivity_technology",
    "telefono": "connectivity_technology",
    "teléfonos": "connectivity_technology",
    "telefonos": "connectivity_technology",
    "citófono": "connectivity_technology",
    "citofono": "connectivity_technology",
    "citófonos": "connectivity_technology",
    "citofonos": "connectivity_technology",
    "dispositivos": "connectivity_technology",
    "dispositivo": "connectivity_technology",
    "tarjeta": "connectivity_technology",
    "tarjetas": "connectivity_technology",
    "equipos tecnología": "connectivity_technology",
    "equipos tecnologia": "connectivity_technology",
    "tecnología": "connectivity_technology",
    "tecnologia": "connectivity_technology",
    "comunicación interna": "connectivity_technology",
    "comunicacion interna": "connectivity_technology",
    "facturación electrónica": "connectivity_technology",
    "facturacion electronica": "connectivity_technology",
    "facturación": "connectivity_technology",
    "facturacion": "connectivity_technology",
    
    # ========== GUEST EXPERIENCE ==========
    "experiencia": "guest_experience",
    "experiencia general": "guest_experience",
    "experiencia general estadía": "guest_experience",
    "experiencia negativa": "guest_experience",
    "experiencia global": "guest_experience",
    ...
    "impresión general": "guest_experience",
    "percepción general": "guest_experience",
    "percepcion general": "guest_experience",
    "percepción general del hotel": "guest_experience",
    "hotel": "guest_experience",
    "ambiente": "guest_experience",
    "atmósfera": "guest_experience",
    "atmosfera": "guest_experience",
    "perfil huésped": "guest_experience",
    "perfil huesped": "guest_experience",
    "familias": "guest_experience",
    "vacaciones": "guest_experience",
    "accesibilidad": "guest_experience",
    "servicios adicionales": "guest_experience",
    "servicios adicionales spa eco": "guest_experience",
    
    # ========== LOCATION SURROUNDINGS ==========
    "ubicación": "location_surroundings",
    "ubicacion": "location_surroundings",
    "ubicación entorno": "location_surroundings",
    ...
    "entorno natural": "location_surroundings",
    "alrededores": "location_surroundings",
    "cerca": "location_surroundings",
    "lejos": "location_surroundings",
    "playa": "location_surroundings",
    "playas": "location_surroundings",
    "mar": "location_surroundings",
    "charcos": "location_surroundings",
    "centro": "location_surroundings",
    "lugar": "location_surroundings",
    "lugar sitio": "location_surroundings",
    "sitio": "location_surroundings",
    "muelle": "location_surroundings",
    "muelle turístico": "location_surroundings",
    "puerto": "location_surroundings",
    "paisaje": "location_surroundings",
    "paisajes": "location_surroundings",
    "vistas": "location_surroundings",
    "vista": "location_surroundings",
    "cultura": "location_surroundings",
    "cultura playas entorno": "location_surroundings",
    ...
    "música": "noise_quietness",
    "musica": "noise_quietness",
    "música ambiente": "noise_quietness",
    "ambiente": "noise_quietness",
    ...
    "lencería": "comfort_furnishings",
    "lenceria": "comfort_furnishings",
    "sábanas lencería": "comfort_furnishings",
